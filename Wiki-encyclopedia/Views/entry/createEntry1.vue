    ...
    <div style="width: 900px;display: flex;flex-direction: column">
      ...
      <div class="mg-top-20">
        <header class="entry-type">
          ...
          <el-radio-group v-if="permission === '0'" v-model="entryType" @change="changeEntryType">
        ...
        <div class="block-container">
          ...
          <el-button class="button-new-category" size="small" @click="showCategoryChooseModel">
            + 添加分类</el-button
          >
        </div>
      </div>
...
import { getAllAttributesByCategoryId } from '@/api/classifyManager'
